...
export default async function ProfilePage({ params }: { params: { username: string } }) {
  ...
  if (!profile) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="text-gray-500 mb-6 font-medium">Profile @{params.username} not found.</p>
  ...
  // Fallback bio if the database column is empty
    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex items-center gap-6">
          ...
          <div>
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">@{params.username}</h1>
